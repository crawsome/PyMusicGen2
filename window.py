...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.pushButton_4, 2, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Play Measure"))
        self.backbutton.setText(_translate("MainWindow", "<- Back One Measure"))
        self.deletebutton.setText(_translate("MainWindow", "Delete Current Measure"))
        self.insertbutton.setText(_translate("MainWindow", "Insert New Measure"))
        self.pushButton_4.setText(_translate("MainWindow", "Forward One Measure ->"))
        self.groupBox_7.setTitle(_translate("MainWindow", "Measure Settings"))
        self.label.setText(_translate("MainWindow", "Beats/measure"))
        self.spinbox_bpmeasure.setSpecialValueText(_translate("MainWindow", "4"))
        self.label_2.setText(_translate("MainWindow", "Beats/minute"))
        self.spinbox_bpminute.setSpecialValueText(_translate("MainWindow", "80"))
        ...
        item.setText(_translate("MainWindow", "Ahava Raba Mode"))
        ...
        self.actionAboout.setText(_translate("MainWindow", "About..."))
